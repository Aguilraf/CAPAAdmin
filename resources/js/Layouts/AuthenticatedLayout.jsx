                            ...
                            {(user.permissions?.includes('ver vacaciones') || user.roles?.some(r => r.name === 'Administrador')) && (
                                <div className="relative ms-3">
                                    <Dropdown>
                                        ...
                                        <Dropdown.Content>
                                            {/* Empleado */}
                                            {user.permissions?.includes('ver vacaciones') && (
                                                <Dropdown.Link href={route('vacations.index')}>
                                                    Mis Vacaciones
                                                </Dropdown.Link>
                                            )}
                                            ...
                                            {user.roles?.some(r => r.name === 'Administrador') && (
                                                <>
                                                    <div className="border-t border-gray-100"></div>
                                                    <div className="px-4 py-2 text-xs text-gray-400">Administración</div>
                                                    <Dropdown.Link href={route('vacations.admin.requests')}>
