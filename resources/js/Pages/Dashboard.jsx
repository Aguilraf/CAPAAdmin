            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        {/* Tarjeta de Mis Requerimientos */}
                        <Link
                            href={route('requirements.index')}
                            className="block group"
                        >
                            <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg border-2 border-transparent hover:border-yellow-500 transition-all duration-200 h-full">
                                <div className="p-6">
                                    <div className="flex items-center justify-between mb-4">
                                        <div className="p-3 rounded-full bg-yellow-100 text-yellow-600 group-hover:bg-yellow-600 group-hover:text-white transition-colors duration-200">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                                            </svg>
                                        </div>
                                    </div>
                                    <h3 className="text-lg font-bold text-gray-900 group-hover:text-yellow-600 mb-2">
                                        Mis Requerimientos
                                    </h3>
                                    <p className="text-gray-500 text-sm">
                                        Consulta y administra tus requerimientos de compra y servicios.
                                    </p>
                                </div>
                            </div>
                        </Link>
