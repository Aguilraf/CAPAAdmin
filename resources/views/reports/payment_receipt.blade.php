...
<head>
    <meta charset="utf-8">
    <title>Recibo de Pago {{ $payment->reference }}</title>
    <style>
...
<body>
    ...
    <div class="place-date">
        {{ mb_strtoupper($payment->organismo->ubicacion ?? 'JOSE MARIA MORELOS, QUINTANA ROO') }}; A {{ mb_strtoupper($fecha_formateada) }}
    </div>
