...
<body>
    ...
    @php
        $finalDescription = $requirement->description;
        ...
        if ($requirement->type === 'cfe' && $requirement->start_date && $requirement->end_date) {
            ...
            if ($startDate->format('Y') === $endDate->format('Y')) {
                $finalDescription = 'PAGO POR EL SERVICIO DE ENERGIA ELECTRICA QUE COMPRENDE EL PERIODO DEL ' 
        ...
        } elseif ($requirement->type === 'viaticos' && $requirement->travelAllowance) {
            $finalDescription = $requirement->travelAllowance->justification ?? $requirement->description;
            if ($requirement->travelAllowance->departure_date) {
